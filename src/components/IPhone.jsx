...
Auto-generated by: https://github.com/pmndrs/gltfjsx
*/
// useGLTF.preload('/models/silver_card.glb')
// useGLTF.preload('/models/gold_card.glb')
...
function Model(props) {
  ...
  const { nodes, materials } = useGLTF(`/models/${props.type}_card.glb`);
  return (
    <group {...props} dispose={null}>
...
// function Model(props) {
//   const { nodes, materials } = useGLTF('/models/scene6.glb')
//   return (
//     <group {...props} dispose={null}>
//       <group rotation={[-1.724, -0.151, -0.012]} scale={0.02}>
//         <mesh
...
// }
// export default Model;
// useGLTF.preload('/models/scene6.glb')